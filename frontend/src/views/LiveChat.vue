<template>
    <div class="live-chat">
        ...
        <div class="row">
            <div class="col">
                <input type="text" class="form-control" placeholder="Enter Message..." v-model="messageContent"
                       @keypress.enter="sendMessage">
            </div>
            <div class="col">
                <button type="button" class="btn btn-primary" @click.prevent="triggerFromRest">Trigger From REST
                </button>
            </div>
        </div>
    </div>
